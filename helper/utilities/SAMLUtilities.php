...
class SAMLUtilities {
	...
	public static function xsDateTimeToTimestamp($time)
    {
        ...
        if (preg_match($regex, $time, $matches) == 0) {
            echo sprintf("nvalid SAML2 timestamp passed to xsDateTimeToTimestamp: ".esc_html($time));
            exit;
        }
    ...
    public static function signXML($xml, $publicCertPath, $privateKeyPath, $insertBeforeTagName = "")
    {
        ...
        if(MSTUSI_DEBUG) MoIDPUtility::mo_debug("Logout Response Generated:" .  $requestXML);
        return $requestXML;
    }
